...
<div ng-app = "donationApp" class = "mainContainer">
	<div ng-strict-di ng-controller = "donationAppController as donationCtrl">
			<div class = 'center'>
				<uib-progressbar max="max" value="dynamic" uib-popover-template ="'js/donationApp/views/donationPopOver.html'" popover-trigger="mouseenter">
				...
				<div class = 'innerCenter'>
					...
					<div style = 'margin-bottom : 5%'>
						...
						style = 'color : #00BFFF;'> <i>Why give $50?</i>
					</div>
				</div>
			</div>
		</div>
